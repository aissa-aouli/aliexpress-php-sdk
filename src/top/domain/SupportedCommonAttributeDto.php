 ...
 * @author auto create
 */
class SupportedCommonAttributeDto
{
	
	/** 
	 * aliexpress common attribute name
	 **/
	public $aliexpress_common_attribute_name;
	
	/** 
	 * aliexpress common attribute name id
	 **/
	public $aliexpress_common_attribute_name_id;
	
	/** 
	 * aliexpress common attribute value list
	 **/
	public $aliexpress_common_attribute_value_list;
